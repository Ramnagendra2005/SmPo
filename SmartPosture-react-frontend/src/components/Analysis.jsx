...
const Analysis = () => {
  ...
  const colors = {
    ...
    cardBg: "bg-white",
    headingGradient: "from-indigo-600 via-purple-600 to-violet-600",
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 via-purple-600 to-violet-600"
            >
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            >
              <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="relative aspect-video bg-indigo-50 flex items-center justify-center overflow-hidden">
                  <motion.div
                  ...
                  {isLoading && (
                    <div className="absolute inset-0 flex items-center justify-center bg-indigo-900 bg-opacity-30 backdrop-blur-sm">
                      <motion.div
                        animate={{ 
                          rotate: 360,
                  ...
                  {cameraError && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-indigo-900 bg-opacity-20 backdrop-blur-sm">
                      <motion.div
                        initial={{ scale: 0.8, opacity: 0 }}
                        animate={{ scale: 1, opacity: 1 }}
                        transition={{ duration: 0.5 }}
                      >
                        <Camera className="h-16 w-16 text-indigo-300 mb-4" />
                      </motion.div>
                      <motion.p 
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.3, duration: 0.5 }}
                        className="text-indigo-900 text-xl font-medium mb-2"
                      >
                      ...
                      <motion.p 
                        ...
                        className="text-indigo-800 text-sm text-center max-w-xs"
                      >
                      ...
                      <motion.button
                        ...
                        className="mt-6 bg-indigo-600 text-white px-6 py-2 rounded-lg font-medium flex items-center"
                      >
                ...
                <div className="p-4 bg-white">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      ></motion.div>
                      <span className="text-sm text-gray-700">Analysis active</span>
                    </div>
                    <motion.span 
                      whileHover={{ scale: 1.05 }}
                      className="text-xs text-indigo-600 font-medium px-2 py-1 bg-indigo-50 rounded-full"
                    >
                    ...
                    >
                      {feedback.length === 0 ? (
                        <motion.div 
                          ...
                          className="flex items-center justify-center py-16 text-center bg-white"
                        >
                      ...
                      <div className="bg-white p-3 border-t border-indigo-100 flex justify-between items-center">
                        ...
                        <motion.span 
                          ...
                          className="text-xs font-medium px-2 py-1 bg-indigo-100 text-indigo-600 rounded-full"
                        >
              ...
              >
                ...
                <div className="p-4 grid grid-cols-2 gap-4">
                  <motion.div 
                    ...
                    className="bg-indigo-50 p-4 rounded-lg relative overflow-hidden group"
                  >
                    <motion.div
                      ...
                      className="absolute right-2 top-2 text-indigo-500 font-bold text-xs"
                    >
                      {overview.postureScore > 50 ? "++" : "--"}
                    </motion.div>
                    <p className="text-gray-600 text-xs mb-1 flex items-center">
                      <BarChart2 className="h-3 w-3 mr-1" /> Posture Score
                    </p>
                  ...
                  >
                    <p className="text-gray-600 text-xs mb-1 flex items-center">
                      <Clock className="h-3 w-3 mr-1" /> Time Tracked
                    </p>
                    <p className="text-purple-600 text-2xl font-bold">{overview.timeTracked}</p>
                    <motion.div 
                      animate={{
                        opacity: [0.5, 1, 0.5],
                      }}
                      transition={{ duration: 2, repeat: Infinity }}
                      className="w-full h-1 bg-purple-200 rounded-full mt-3"
                    />
                  </motion.div>
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      <motion.li 
                        key={i}
                        variants={itemVariants}
                        className="flex items-center text-gray-700 bg-indigo-50 p-2 px-3 rounded-lg"
                        whileHover={{ x: 5 }}
                      >
                        <motion.span 
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white px-8 py-4 rounded-lg font-bold text-lg shadow-lg inline-flex items-center"
            >

...
//         className="bg-white p-8 rounded-lg shadow-lg text-center w-full max-w-sm"
//       >
...
//           whileTap={{ scale: 0.95 }}
//           className="w-full px-4 py-2 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none"
//         >
//           Sign in with Google
//         </motion.button>
//       </motion.div>
